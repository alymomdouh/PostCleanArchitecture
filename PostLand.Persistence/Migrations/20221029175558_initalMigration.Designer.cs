...
namespace PostLand.Persistence.Migrations
{
    ...
    [Migration("20221029175558_initalMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PostCleanArchitecture.Domain.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("PostCleanArchitecture.Domain.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PostCleanArchitecture.Domain.Post", b =>
                {
                    b.HasOne("PostCleanArchitecture.Domain.Category", "Category")
                        .WithMany("Blogs")
